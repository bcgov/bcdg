...
3. After your team and content repo are set up - either using our self-serve tool or during a working session you'll have a GitHub repository containing starting points for your team to use as it creates documentation and other elements for publishing your content into DevHub, including the automated publishing Action mentioned previously. At this point, your team may have some remaining "homework" to adapt your content for DevHub. The amount of work will depend on the state of your documentation. You can complete these items on your own timeline.
