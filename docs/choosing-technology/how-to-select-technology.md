...
We offer a wide range of options within B.C. Government systems. The tables below shows a cross-section of some technology that developers can use. Each option links to more information about it. 


## Current technology options

Although there's numerous choices available, the table below isn't exhaustive, nor represents an endorsement of any particular option. Every team should do its own research before deciding which technology best suits their needs and context.
