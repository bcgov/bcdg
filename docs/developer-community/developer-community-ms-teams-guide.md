...
This guide explains how the [Developer Community](https://teams.microsoft.com/l/team/19%3A6bffce0ac7aa47a1ba9f6d9a7e898db9%40thread.tacv2/conversations?groupId=a80418da-c27b-406e-89ab-7695b61924d8&tenantId=6fdb5200-3d0d-4a8a-b036-d3685e359adc) Microsoft Teams team works, who it is for and how internal teams can request new public channels through the Developer Experience (DevX) team.

It replaces the previous Rocket.Chat guidance.

### Who this is for

This space is for internal teams who need to collaborate with developers and platform users, and foundational technologies in B.C. government through tools or services.
...
Coordinating between developers and internal delivery teams.
...
Each public channel has at least two channel owners such as product owner and/or technical lead.  
...
Members include any internal users who join the channel.
...
* Channel description and links to any supporting documentation to include in your channel description
* Owning team and channel owner(s): Product owner and technical lead
...
Once approved, DevX creates the channel and assigns the channel owners. You will be notified through the JSM ticket when the channel is ready.
