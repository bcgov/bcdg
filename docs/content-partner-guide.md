...
3. After your team and content repo are set up - either using our self-serve tool or during a working session - your team may have some remaining "homework" to adapt your content for DevHub. The amount of work will depend on the state of your documentation. You can complete these items on your own timeline.
